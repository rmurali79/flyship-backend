...
echo "  shipper1@flyship.test .. shipper10@flyship.test"
echo "  traveler1@flyship.test .. traveler10@flyship.test"
echo ""
echo -e "${BOLD}${GREEN}Itineraries (travel plans) seeded:${RESET}"
echo "  ~3-5 per traveler, spanning past/present/future dates"
echo ""
echo -e "${BOLD}${GREEN}Demo shipments seeded (100 total):${RESET}"
echo "  15x submitted          (pending, no quotes — itinerary created)"
echo "  20x quotation received  (pending, 1-2 quotes pending)"
echo "  20x quotation accepted  (accepted, escrow funded, pickup pending)"
echo "  20x itinerary in progress (in_transit, package picked up)"
echo "  20x item delivered      (delivered, full history trail)"
echo "   5x cancelled           (with cancellation reason)"
echo ""
ok "Done."
